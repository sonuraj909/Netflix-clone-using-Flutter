...
class _$_Downloads implements _Downloads {
  const _$_Downloads({required this.poster_path});
  ...
  @override
  String toString() {
    return 'Downloads(poster_path: $poster_path)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, poster_path);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads({required final String? poster_path}) = _$_Downloads;
